...
question_add = {
	...
	composeEntity : function composeEntity() {
		...
		question_entity.description = $(".question-content textarea").val().substring(0, 100);
