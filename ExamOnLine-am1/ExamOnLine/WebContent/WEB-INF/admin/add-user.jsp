				...
				<div class="row">
					<div class="col-xs-3">
						<ul class="nav default-sidenav">
							<li>
								<a href="user-list.html"> <i class="fa fa-list-ul"></i> 会员管理 </a>
							</li>
							<li class="active">
					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							...
							<form id="user-add-form" style="margin-top:40px;"  action="admin/add-user">
								...
								<div class="form-line form-job-type" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>默认班级：</span>
									<select id="job-type-input-select" class="df-input-narrow">
										<option value="-1">--请选择--</option>
			...
			bindSubmitForm : function bindSubmitForm() {
				...
				form.submit(function() {
							...
							if (result) {
								...
								data.classID = $("#job-type-input-select").val();
								...
								jQuery.ajax({
											...
											success : function(message, tst, jqXHR) {
												if (message.result == "success") {
													document.location.href = document.getElementsByTagName('base')[0].href + "admin/user-list";
												} else {
