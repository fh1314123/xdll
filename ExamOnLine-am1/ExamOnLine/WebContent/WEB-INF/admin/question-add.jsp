  ...
  <head>
	...
	<body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-7" id="login-info">
								...
								<a href="j_spring_security_logout" class="btn btn-primary"><i class="fa fa-sign-out"></i> 退出</a>
						...
						<div class="page-content row">
							<form id="question-add-form" style="margin-top:40px;">
										...
										<div class="clearfix">
											<div id="aq-course1" style="padding:0px;float:left; width:48%;">
												<select id="field-select" class="df-input-narrow" size="4" style="width:100%;">
													<c:forEach items="${knowlegePoints }" var="knowlegePoint">
														<option value="${knowlegePoint.point_id }"
														   onclick="change(this)">${knowlegePoint.point_name }</option>
													</c:forEach>
												</select>
											</div>
								...
								<div class="form-line question-content">
									...
									<textarea id="addQuestion" name="addQuestion"  
									style="width: 530px; height: 230px; margin: 0 auto;"></textarea>  
								...
								<div class="form-line form-question-difficulty" style="display: block;">
									<span class="form-label"><span class="warning-label"></span>难度：</span>
										<input type="text" class="df-input-narrow"  id="difficulty"><span class="form-message"></span>
									<br>
								</div>
		...
		function  change(op){
			...
			point_list.append("<option value=\"" + $(op).val() + "\">" + $(op).html() + "</option>");
			$(op).remove();
		}
		</script>
	</body>
